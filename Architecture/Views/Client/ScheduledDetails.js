...
export default class ScheduledDetails extends Component
 {
    constructor(props) {
        super(props);
        ...
        return (
          ...
          <FlatList
              ...
              renderItem={({ item , index}) => 
                ...
                />
          <Text style={{alignItems: 'flex-start',alignSelf:'flex-start',color: 'white',marginLeft:20,marginRight:20,marginTop:15,fontSize:22,marginBottom:10,}}>
              Conversation ongoing chat window for anything client and mechanic discussed
          </Text>
          <View
            style={{
              borderColor: 'white',
          ...
          {
            jobDetails.request_status != "0" ? 
            <TouchableOpacity style={[styles.buttonContainer, styles.connectButton]} 
              onPress={() => this.didTapOnCloseJobs()} >
          <Text style={styles.connectText}>Review Job</Text>
          </TouchableOpacity>  : 
      <TouchableOpacity style={[styles.buttonContainer, styles.connectButton]} 
              onPress={() => this.didTapOnCloseJobs()} >
          <Text style={styles.connectText}>Close Job</Text>
          </TouchableOpacity>
          }
          </View>
          </ScrollView>
