...
export default class EditProfileVehicle extends Component
 {
  ...
  componentWillMount = async () => {
    ...
    const {passProfileVehicle} = this.props.route.params;
    vehicleDetails = passProfileVehicle;
    console.log('vehicle details : ', passProfileVehicle);
    this.setState({ make : passProfileVehicle.vehicle_make });
    this.setState({ model : passProfileVehicle.vehicle_model });
    this.setState({ year : passProfileVehicle.vehicle_year });
